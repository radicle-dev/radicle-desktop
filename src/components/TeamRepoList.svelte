  ...
  <HoverPopover placement="bottom-start" stylePadding="1rem">
    ...
    {#snippet popover()}
      <div class="popover">
        ...
        <!-- prettier-ignore -->
        <p>This team lists the repository in <code>.radicle/team.json</code>, and the repository names this team in its identity document, under <code>xyz.radicle.teams</code>.</p>
        <p>
