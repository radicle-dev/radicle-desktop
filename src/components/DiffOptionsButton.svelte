<script lang="ts" module>
  ...
  // Only icons from the app's own set (see `Icon.svelte`).
...
<!-- On/Off switch matching the app's settings switches (two joined ghost
     buttons, e.g. `AnnounceSwitch`/`BadgeCounterSwitch`). -->
